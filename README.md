...
может быть как доступным в любой точке земного шара, так и изолированным от внешнего мира в соответствии с корпоративными стандартами, принятыми в организации.
