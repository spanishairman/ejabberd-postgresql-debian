...
Протокол [_XMPP_](https://xmpp.org/about/technology-overview/) позволяет использовать один из тысяч бесплатных серверов в сети интернет если ты обычный пользователь или поднять свой сервер, в случае необходимости 
