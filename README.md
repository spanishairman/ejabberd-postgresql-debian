...
пока количество резервных копий в томе не достигнет максимального значения (параметр ***Maximum Volume Jobs = 7***). Следующая задача запишет новую копию в новый том, 
