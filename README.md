...
Чтобы добавление узла в кластер прошло успешно, необходимо обеспечить разрешение имён нод на DNS-службе или в файлах _hosts_ всех узлов кластера, после чего можно проверить доступность нод между собой:
```
